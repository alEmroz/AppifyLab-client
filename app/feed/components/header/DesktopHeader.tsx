            ...
            <ul className="flex items-center gap-5">
              ...
              <li ref={notifRef} className="relative">
                ...
                >
                  ...
                  <span className="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center">6</span>
                </button>
                {notifOpen && (
              ...
              <li>
                <a href="/chat" className="flex items-center justify-center w-10 h-10 rounded-lg hover:bg-gray-100 relative">
                  ...
                  <span className="absolute -top-0.5 -right-0.5 bg-red-500 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center">2</span>
                </a>
              </li>
            </ul>
