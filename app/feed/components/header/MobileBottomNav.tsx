        ...
        <ul className="flex items-center justify-between py-2">
          ...
          <li>
            <a href="/notifications" className="flex flex-col items-center gap-0.5 px-3 py-1 relative">
              ...
              <span className="absolute -top-0.5 right-1 bg-[#1890FF] text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center">6</span>
            </a>
          </li>
          <li>
            <a href="/chat" className="flex flex-col items-center gap-0.5 px-3 py-1 relative">
              ...
              <span className="absolute -top-0.5 right-1 bg-[#1890FF] text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center">2</span>
            </a>
          </li>
          <li>
