...
export default function ExploreNav() {
  return (
    <div className="bg-white rounded-md px-6 py-6 mb-4">
      <h4 className="text-base font-semibold text-[#212121] mb-6">Explore</h4>
      <ul className="space-y-1">
        {items.map((item) => (
          <li key={item.label}>
            <a
              href={item.href}
              className="flex items-center gap-3 px-2 py-2.5 rounded-md text-sm text-[#666666] hover:text-[#1890FF] hover:bg-gray-50 transition-colors"
            >
              ...
              {item.badge && (
                <span className="ml-auto bg-[#e8f4ff] text-[#1890FF] text-[10px] font-medium px-2 py-0.5 rounded">
                  {item.badge}
                </span>
              )}
            </a>
